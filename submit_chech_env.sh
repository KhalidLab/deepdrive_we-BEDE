...
#SBATCH -o env_check_%j.out        # output file
#SBATCH -e env_check_%j.err        # error file
...
# Let's you check you conda enviroment and CUDA installation

# 1. Source the base conda configuration
source /nobackup/projects/<project_code>/<user_name>/aarch64/conda_folder/miniconda/etc/profile.d/conda.sh
